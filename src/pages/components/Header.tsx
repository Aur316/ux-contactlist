...
export default function Header() {
  ...
  return (
    <div className=" customMax:justify-center flex flex-col justify-between items-center w-[60%] max-w-[720px] h-[48px] mx-[22px] custom:flex-row  custom:w-[60%] max-w-[720px]  ">
